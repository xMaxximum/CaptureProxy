...
namespace CaptureProxyTests
{
    public class CapturedUnitTests
    {
        ...
        public void Setup()
        {
            Events.BeforeTunnelConnect += Events_BeforeTunnelConnect;
        ...
        {
            Events.BeforeRequest += ResponseModifyTest_BeforeRequest;
            Events.BeforeResponse += ResponseModifyTest_BeforeResponse;
        ...
        private void ResponseModifyTest_BeforeRequest(object? sender, CaptureProxy.MyEventArgs.BeforeRequestEventArgs e)
        {
            e.CaptureResponse = true;
        }

        private void ResponseModifyTest_BeforeResponse(object? sender, CaptureProxy.MyEventArgs.BeforeResponseEventArgs e)
        {
